...
public class POS extends javax.swing.JFrame {
    ...
    public void tableShow(){
        ...
        try {
            Statement s = student.con.createStatement();
            
            student.rs = s.executeQuery("Select * From pos");
            
            while(student.rs.next()){
                Vector v = new Vector();
                
                v.add(student.rs.getInt(1));
                v.add(student.rs.getString(2));
                v.add(student.rs.getInt(3));
                v.add(student.rs.getInt(4));
    ...
    private void initComponents() {
        ...
        jPanel1.add(friesBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 10, 94, 69));
        ...
        jPanel1.add(cokeBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 150, 107, 69));
        ...
        jLabel7.setText("0");
        jPanel1.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 230, 80, -1));

        jLabel8.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel8.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel8.setText("0");
        jPanel1.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 90, 30, -1));
        ...
        jPanel2.add(changeBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 390, -1, -1));
        ...
        jPanel2.add(resetBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 430, 80, 30));
        ...
        jPanel2.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 430, 140, 30));
...
//        try
//        {
//            student.ps = student.con.prepareStatement("Insert into pos (Product,Quantity,Price) Values(?,?,?)");
//            
//            student.ps.setString(1,"Burger");
//            student.ps.setInt(2, 1);
//            student.ps.setInt(3,45);
//            
//            int check = student.ps.executeUpdate();
//            
//            if(check == 1){
//                
//                while(student.rs.next()){
//                    totalFld.setText(student.rs.getString(1));
//                }
//            }
//          
//            tableShow();
...
//        try
//        {
//            student.ps = student.con.prepareStatement("Delete from pos where Id = ?");
//            student.ps.setInt(1,Integer.parseInt(codeFld.getText()));
//            
...
//        {
//            student.ps = student.con.prepareStatement("Insert into pos (Product,Quantity,Price) Values(?,?,?)");
//            student.ps.setString(1,"Fries");
//            student.ps.setInt(2,1);
//            student.ps.setInt(3, 25);
//            
//            student.ps.executeUpdate();
//            
//            tableShow();
...
//        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        areaTxt.setText(areaTxt.getText()+"\n+++++++++++++++++++++++++++++++++\n");
        areaTxt.setText(areaTxt.getText()+"++++++++++THANKS COME IN AGAIN++++++++++++\n");
        areaTxt.setText(areaTxt.getText()+"+++++++++++++++++++++++++++++++++");
